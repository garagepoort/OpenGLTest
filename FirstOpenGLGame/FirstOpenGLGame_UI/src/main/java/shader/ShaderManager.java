...
public class ShaderManager {
	...
	public static void initializeShaders(){
		...
		try{
			BufferedReader reader = new BufferedReader(new FileReader("src/main.java.shader/vertexShaderLight.vert"));
			String line;
		...
		try{
			BufferedReader reader = new BufferedReader(new FileReader("src/main.java.shader/fragmentShaderLight.frag"));
			String line;
			while((line = reader.readLine()) != null){
...
//			System.err.println("Vertex main.java.shader wasn't compiled correctly");
//		}
		if (ARBShaderObjects.glGetObjectParameteriARB(vertexShader, ARBShaderObjects.GL_OBJECT_COMPILE_STATUS_ARB) == GL_FALSE)
			throw new RuntimeException("Error creating main.java.shader: " + getLogInfo(vertexShader));
...
//		}
		if (ARBShaderObjects.glGetObjectParameteriARB(fragmentShader, ARBShaderObjects.GL_OBJECT_COMPILE_STATUS_ARB) == GL_FALSE)
			throw new RuntimeException("Error creating main.java.shader: " + getLogInfo(fragmentShader));
