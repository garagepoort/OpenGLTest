...
import static be.davidcorp.view.ui.panel.UIComponentCollisionChecker.isPointInsidePanel;
...
public abstract class UIComponent {
	...
	public boolean checkMouseClick(int x, int y, MouseButton buttonClicked) {
		if (isVisible() && !isClosed() && clickable && isPointInsidePanel(this, new Point(x, y, 0))) {
	...
	public synchronized void fireOnLeftClickEvent(int x, int y) {
		if (isPointInsidePanel(this, new Point(x, y, 0))) {
